package com.biswaljava.jdbc.data.service;
...
import com.biswaljava.jdbc.hsql.HsqlDatabase;
import com.biswaljava.jdbc.model.Todo;
...
public class TodoDataServiceSpringJdbc {
	...
	/*
	 * com.biswaljava.jdbc.data.service.TodoDataServiceSpringJdbc [Todo [id=0,
