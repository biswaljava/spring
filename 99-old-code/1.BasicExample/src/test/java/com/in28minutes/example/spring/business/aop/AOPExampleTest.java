package com.biswaljava.example.spring.business.aop;
...
//execution(* com.biswaljava.example.spring.business.aop.HiByeService.*(..))
...
@ComponentScan(basePackages = { "com.biswaljava.example.spring.business.aop" })
...
@Component
class MyAspect {
	@Before("execution(* com.biswaljava.example.spring.business.aop.HiByeService.*(..))")
	...
	@AfterReturning(pointcut = "execution(* com.biswaljava.example.spring.business.aop.HiByeService.*(..))", returning = "result")
