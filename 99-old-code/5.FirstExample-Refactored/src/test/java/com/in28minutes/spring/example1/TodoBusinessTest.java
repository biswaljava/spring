...
import com.biswaljava.spring.example1.businessservice.TodoBusinessService;

@Configuration
@ComponentScan(basePackages = {
		"com.biswaljava.spring.example1.businessservice",
		"com.biswaljava.spring.example1.dataservice.stub" })
class SpringContext {
}
